		...
		<div class="flex items-baseline justify-between gap-3">
			...
			{#if data.run.can_edit}
				<a
					...
					class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded border border-ocean-600 text-ocean-300 hover:bg-ocean-600 hover:text-white text-sm font-medium transition-colors shrink-0"
				>
